export const abi = [
    ...
    outputs: [
      {
        type: "tuple[]",
        name: "",
        internalType: "struct JaothuiCertNFTV5.History[]",
        components: [
    ...
    outputs: [
      {
        type: "tuple",
        name: "",
        internalType: "struct JaothuiCertNFTV5.BUFFALO",
        components: [
    ...
    outputs: [
      {
        type: "tuple[]",
        name: "",
        internalType: "struct JaothuiCertNFTV5.REWARD[]",
        components: [
          { type: "string", name: "uri", internalType: "string" },
          { type: "uint256", name: "createdAt", internalType: "uint256" },
        ],
  ...
  },
  {
    ...
    inputs: [{ type: "string", name: "_desc", internalType: "string" }],
  },
  {
    type: "function",
    stateMutability: "view",
