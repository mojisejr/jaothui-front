...
- **📦 PR convention (evidence-decided 2026-07-05)**: `redesign/v2` was cut from `main`, and `main` is ahead of `staging`, so this branch's clean-diff base is **`main`** (not the repo's usual feature→`staging`). Operator confirmed: **PR `redesign/v2` → `main`**. AI opens the PR; operator merges.
...
---
*Generated by Oracle on: 2026-03-05 · v2 redesign notes appended 2026-07-05*
